...
A. M. Thorn.  ORCID 0009-0008-5463-278X.  Hub: twistj.com.
Date: 7 July 2026.
Consolidates e4abd3f5..99e592f0 (3 July evening through the morning of
7 July 2026) on top of TWIST_J_Canon_v158_CONSOLIDATED (7e26091e,
the reading of spacetime).
Every Part below summarizes a committed source named by its hash; no
summary is stronger than its committed label. Book (vesmirkniha)
commits of the same span are derivative prose and are not physics
sources; they are listed nowhere below.
```
...
Four days, five arcs, one method. The substrate knit tied both
W-CENSUS faces to a single verb state and the second cut of the four
gave the observer his alternator hinge. The boost became a count. The
FRW canonical form reached T at the rank-1 (00) equation through the
explicit action sum, and the coupling cell 864 pi was DERIVED from J,
discharging the gravity paper's last [I]. Attack B then ran nine
preregistered strikes at the measure: eight corpses carved the
survivor identikit clause by clause, the kernel-to-cell dictionary
closed at D, and the NINTH LANDED: the magnetic face law
mu = w(k)/10 emerges exactly, with zero parameters, from the axiom
pair of closed orbits at the Thue-Morse oriented slot. In parallel the
313 census stopped being a count and became theorems: hosting
multiplicities, the pairing involution, the z5 sheet, and
313 = 2 x 144 + 24 + 1 now stand on the kernel plus Thue-Morse. The
abelian face measure is realized on BOTH halves. The electron program
opened its next instrument: O-DIRAC-LADDER is registered with gates
preregistered, execution in flight.

## Part I. The substrate knit and the second cut of the four

Sources: 05d24f62 (patch), 8686086b (verifier pinned before run),
e4abd3f5 (landing), a9f91afe (completion).

THE SUBSTRATE KNIT (12 of 12, both architectures): T-QS-BORN-FACES
(both W-CENSUS faces are the two conjugate Born readouts of the SINGLE
verb state on the P6 qudit); T-QS-GRAM (the Gram knit
C_J C_J^T = circulant(2, 1, 0, 0, 1) with spectrum w; T-Q1 re-pinned);
T-QS-MUB (the two face bases mutually unbiased, 1/5 on all 25 pairs);
T-QS-QUANTA-MOMENTS; Plancherel masses 2 and 10 in the ratio p = 5.
The O-QUANT-SUBSTRATE leg of the PS-G-2/Gb gate is made concrete;
F-QS-KNIT registered.

D-SPLIT22 (Observer Alternator Theorem, 18 of 18 on aarch64 and
x86_64, stdout bit-identical, Psi cross-platform witness on file):
the observer reads 4 = 1 + 3, the substrate counts 4 = 2 + 2, and the
hinge between the two partitions of mu_4 is the alternator with
lambda = -1. R-SPLIT22-FROZEN recorded; O-SPLIT22-FORCE-GRADING
CLOSED at the completion (a9f91afe); F-SPLIT22-FORCE-SWAP registered.
D-FROZEN-AXIS: the boost axis IS the alternator (R promoted to D).
Six verifiers land in split22/ with a four-machine witness matrix;
re-emission provenance disclosed in the landing note.

## Part II. Velocity is a count

Sources: 3da0da2d, 228f087d (Rev1), 9c28ae2a (cross-platform gate).

D-BOOST-COUNT-LADDER (D on the T-LOCK base T-BOOST-READING-SPLIT,
v140; 8 of 8 exact over Q(sqrt5), both architectures, SHA-256 pinned):
the substrate counts integer rapidity steps log phi; the decoder reads
beta_n = tanh(n log phi) with exact Fibonacci and Lucas parity
(sqrt5 F over L even, L over sqrt5 F odd); Einstein velocity
composition IS index addition; subluminality is the unit-norm identity
L^2 - 5 F^2 = 4 (-1)^n in Z[phi]. The photon belongs to the null light
branch (E+ E- = 0 identically), not the last rung of massive
acceleration; Rev1 sharpened exactly this wording and registered the
no-promotion clause. Zero free parameters, no axiom change.

## Part III. The action sum closes and the coupling is counted

Sources: d341bf1e, 79a22296, 0bda0daf, ff5f84c6, ef93a86d, 56da9341.

O-S-L5-ACTION-SUM CLOSED (PREREG-SL5-SUM-1, d341bf1e): the FRW
canonical form is promoted D to T at the rank-1 (00) equation; the
J-coordinate source stands on the explicit S_L5 graph-action sum, no
longer on a reading principle. A second independent instrument
(79a22296, 34 of 34 both architectures, byte-identical) delivers the
exact Green function on the A_3 carrier with NO status movement.

THE COUPLING FROM COUNTING (fifth paper, 0bda0daf, 26 of 26 both
architectures): 864 pi is DERIVED from J; the fourth paper's [I] label
is discharged to [D]; six independent selectors of d = 3 recorded.
The continuum action paper v1 lands (ff5f84c6): from the integer
J-Cayley plenum to the continuum action.

O-ELL-G-SI (ef93a86d, 10 of 10 both architectures, no status
movement): pinned to ONE consistency equation; the Planck form
ell_P / lambda_e = (32/33) alpha^10 / sqrt(g); the exponent identity
G_T = alpha^(20 + sigma). PREREG-ELL-G-WALL-1 (56da9341, 8 of 8 both
architectures): the wall is a MECHANISM wall, not a numerics wall;
T-33-FACES proved; D-SS40-TIER1-OPTIMUM; N-EXACT-MONOMIAL-NULL; the
G2 gray zone 38 recorded verbatim.

## Part IV. Attack B, strikes one through eight: the identikit

Sources: e21935bd/16aa1aa5, 7c2a02f5/5e684b25, 1c3f3aed/2adc6174,
7a2180c9/c8df7108, 23ff4575/e17ba6c3/2c654943, 4a3e241d,
7fb4a2b7/0215ce46, 04896ae0/837a921f, 45ea9f8a/0a9ea7be, 91a9e1e0.

Nine preregistrations, eight first-class corpses, every gate fixed
before computation, every rev 1 defect disclosed in place:

```
KCM-1  the realized A-ensemble          F-KCM-MEASURE-MISMATCH clause 1
KCM-2  the Born A-ensemble              dies by a Galois obstruction
KCM-3  the Legendre-read verb state     dies in the reality trap;
                                        D-KCM-REALITY-TRAP registered
KCM-4  the Gauss-kernel verb state      breaks the rationality wall,
                                        dies in the magnitude gap;
                                        edgewise class EXHAUSTED
KCM-5  the minimal closed-tick ensemble fires AS PREDICTED and
                                        REVEALS the electric law:
                                        D-KCM-TICK-ELECTRIC-LAW (D),
                                        P = J/2 on the 12 electric
                                        faces from the bare tick;
                                        D-KCM-ELECTRIC-BLINDNESS;
                                        D-KCM-FORK-UNIFICATION; the
                                        measure problem is HALVED
KCM-6  hop plus derived diagonal        fires on the magnetic gate;
                                        the diagonal retracted, the
                                        electric law protected, the
                                        disease named: the Bianchi
                                        constraint (O-KCM-TICK-
                                        DIAGONAL had closed at D,
                                        4a3e241d: omega = |Jhat|^2 = w
                                        forced by SS108.31)
KCM-7  the quotient transcription       fires AS PREDICTED in closed
                                        form; the classical
                                        transcription route EXHAUSTED
KCM-8  the quantum trace sandwich       the class is closed by the
                                        Galois wall; the target itself
                                        filters out ALL counting
                                        measures; D-KCM-MOMENT-
                                        FACTORIZATION, D-KCM-SANDWICH-
                                        GALOIS-OBSTRUCTION, D-KCM-
                                        IRRATIONALITY-FILTER (counts
                                        may enter only as amplitudes)
```

D-KCM-ORBIT-MAP (91a9e1e0, 18 PASS both architectures): the
kernel-to-cell dictionary at D. OM.1 directions (time = the clock
tick; space = the three F_5 directions of ker(Tr_4), isotropic under
the Galois Gram; fiber = the Z_5 edge variable, F = dA). OM.2
deposits (PS-ENG-1 winding increments, additive, valued in fifths,
flux quantum zeta_5). OM.3 amplitudes (unimodular t^(k Phi) per line;
the measure is the Born square; the irrationality filter binds).
H-KCM-CROSSING-MEAN registered with its exact anchor:
(27 + sqrt5)/72 + (27 - sqrt5)/72 = 3/4 = the mean crossing offset
over (1/2, 1/4, 1/4) on (0, 1, 2); made a MANDATORY gate of KCM-9.

## Part V. The ninth strike lands: the magnetic law emerges

Sources: 3b654b4c (prereg), ed32c354 (outcome,
TWISTJ_Canon_Note_D_KCM_MAGNETIC_EMERGENCE.md), 944b5349 (lock
record). Prereg sha 51b9b03b..., committed BEFORE the probe existed;
probe rev 1 self-caught at integrity gate A4 (exit 2, no verdict,
stdout kept); rev 2 sha eb48548a..., 20 of 20, stdout c268fdd8...,
byte-identical JAS 2 aarch64 and TWISTER x86_64.

D-KCM-MAGNETIC-EMERGENCE (NEW, D). Over six preregistered loop
ensembles of the recurrent mirror algebra <b, d, e>, exactly ONE
passes the magnetic gate: E4, the axiom pair at slot 1, the trivial
closed orbit plus the unique non-crossing simple loop d, deposits
{0, 1}:
...
entrywise exact in Q(sqrt5). The Born square of the verb realized as
MOTION: stay, or twist once. The ninth clause of
F-KCM-MEASURE-MISMATCH did NOT fire. The slot-4 axiom pair lands on
w(2k)/10, the sigma_2 Galois image, EXACTLY: the two time layers of
the plaquette carry the TWO golden places; the index-2 break the
identikit demanded IS the slot orientation, supplied by the
Thue-Morse bit; the suppressed layer is the layer of the verb quantum
2, and (2|5) = -1: H-SIGN-LEGENDRE realized at D on the abelian face
(tilt exactly -sqrt5/5). The electric law is preserved by scope
(support disjoint from the time-space faces). Moments
(1, 1/2, 0, 0, 1/2): the mean holonomy 1/2 is the electric echo.

F-KCM-CROSSING-MEAN FIRED as scoped and as hand-predicted: none of
the four preregistered block functionals of the survivor lands
(27 +- sqrt5)/72 with identity 1/4; H-KCM-CROSSING-MEAN dies in its
unoperationalized form; the anchor identity itself stands exact;
O-KCM-CROSSING-FUNCTIONAL OPENS as named in the prereg.

WITH KCM-5: the abelian face measure is realized on BOTH halves by
zero-parameter ensembles, electric from the bare tick, magnetic from
the closed loop pair. The v154 measure bottleneck, as scoped by the
KCM-5 halving, CLOSES at the face level.

## Part VI. The census becomes theorems

Sources: ef8756e6, 65991f3b, 3dbdb6cf, 828f5a40.

PREREG-313-NEGATION (ef8756e6, 10 of 10 both architectures, rev 1
self-falsification kept as evidence): T-313-FACES, T-63-MERSENNE-FACE,
T-HULL-CUBIC proved; D-313-B-INVARIANCE and the special support
characterized exactly; F-313-SINGLE-FIXED fired on schedule;
O-HYPERPLANE-MERSENNE reshaped.

PREREG-PISTON-CENSUS (65991f3b, 8 of 8 both architectures, three
falsifiers fired en route, rev 1 kept): the census is a V4 hosting
count; 313 = 13^2 + 12^2 REALIZED; D-PISTON-V4-HOSTING locked; the
hyperplane 63 = (p^3 + 1)/2 realized; O-HYPERPLANE-MERSENNE CLOSED
at D.

PREREG-PAIR-MAP (3dbdb6cf, 7 of 7 both architectures, no falsifier
fired): the pairing map CAUGHT: Phi = (b4 d4, identity fiber), an
involution, 144 transpositions plus 25 fixed points; classes modulo
Phi = 169 = 13^2 = the V4 orbit census; D-PAIR-MAP locked;
D-CENSUS-Z5-SHEET locked: every census state has z5 in {1, 4}, the
recurrent algebra is the mirror algebra <b, d, e>, and a, c never
fire on the attractor.

PREREG-HOSTING-RULE (828f5a40, 8 of 8 both architectures):
O-PISTON-HOSTING-RULE CLOSED AT T. The attractor formula
A = H1 x' union b H1 x' holds on ALL 313; the return group
H1 = <d, b e b> has order 10 with the line translation
T0 = (0, 0, 0, 0, 3, 2); the hosting multiplicities (2, 1, 1) and the
decomposition 313 = 2 x 144 + 24 + 1 are THEOREMS of the kernel plus
Thue-Morse; the pairing realizes as
Phi = t(0, 0, 0, 0, 1, 1) o b o d inside <b, d, e>.

## Part VII. Three notes and one registration in flight

Sources: 501edc91, bcdf6852, f8470701, 125100f9, 99e592f0.

Canon patch LADDER-ALTERNATOR-BASIS: one beat = one boost times one
alternator tick. Canon note TM-BREATH-TOWER: the alternator is breath
at one scale, Thue-Morse at every scale. Canon note FERMIONIZER: the
two that makes matter out of light.

PREREG-DIRAC-LADDER FILED (125100f9): O-DIRAC-LADDER registered at O;
the light cone u = 2 phi^n, v = 2 phi^(-n), u v = 4; the alternator
as N(phi)^n; F_m the integer square root of the cat map; the spinor
floor N(phi) = -1; Dirac step and place-id gates G1..G5 preregistered
with falsifiers; verifier attached (25 checks, exact). Executed the
same night (99e592f0): gates G1 and G2 PASS, 25 of 25, byte-identical
on JAS 2 aarch64 and TWISTER x86_64; per the preregistered rule
T-LADDER-LIGHTCONE and T-SPINOR-FLOOR promote T-cand to T;
O-DIRAC-LADDER stays O pending G4; G3, G4, G5 open; no falsifier
fired. The remaining gates fold in v160.

## Falsification registry (v159 delta)

```
FIRED, first-class, all preregistered:
   F-KCM-MEASURE-MISMATCH clauses 1 through 8 (the eight corpses of
      Attack B; the NINTH clause did NOT fire);
   F-313-SINGLE-FIXED (on schedule);
   three piston-census falsifiers en route (rev 1 kept);
   F-KCM-CROSSING-MEAN (as scoped; the anchor stands, the block
      reading dies; O-KCM-CROSSING-FUNCTIONAL opens).
REGISTERED AND SILENT: F-QS-KNIT, F-SPLIT22-FORCE-SWAP,
   F-KCM9-ELECTRIC, the Dirac ladder falsifiers of G1..G5.
Rev 1 discipline: three probes self-caught and were kept as evidence
   (313-negation rev 1, piston census rev 1, KCM-9 rev 1 at gate A4);
   the exit-2 no-verdict rule held every time.
No falsifier fired against any prior LOCK.
```

## Open obligations (v159 delta)

```
CLOSED at T   O-S-L5-ACTION-SUM (FRW rank-1 (00) canonical form);
              O-PISTON-HOSTING-RULE.
CLOSED at D   O-KCM-ORBIT-MAP; O-KCM-TICK-DIAGONAL;
              O-HYPERPLANE-MERSENNE; O-SPLIT22-FORCE-GRADING;
              the v154 measure bottleneck at the face level (both
              halves realized by zero-parameter ensembles).
DISCHARGED    the fourth paper's [I] on 864 pi, to [D] (fifth paper).
OPENED        O-KCM-CROSSING-FUNCTIONAL (find the registered
              functional carrying the SS6A.2 blocks onto the cell, or
              derive that none exists);
              O-DIRAC-LADDER (registered; G1, G2 landed at T; stays O
              pending G4; G3, G4, G5 open).
THE WALL NOW  unchanged in kind: O-QUANT-SUBSTRATE gates PS-G-2 and
              Gb; the non-abelian measure lift (SL_3(F_5) side); the
              shared archimedean 2 pi U(1) circle. The abelian face
              is no longer part of the wall.
```

## Verifier index (v159 delta)

```
KCM-9      prereg sha 51b9b03b3acaf6ab4a976ceabc68c298211dc3350ce6135212290d2c3c7fd686
           probe rev 2 sha eb48548a4bc275cee1b96195a3ac45c6d6bd1a98df29ca49daa0bccc189b1995
           stdout sha c268fdd8bd4172c86213dcc0722af231bc4d1e2bdd8e02c53dfd3dbd223e5edb
           (rev 1 952e8010..., its A4 stdout 7f95427d..., kept)
PAIR-MAP   prereg sha d938f606dc05d5262e1eeaca56f4e5a5b3b0fd21a4f1fef9e7882174433f1469
           probe rev 2 sha c0a87ca9b3610a4de4e8f8dc4fc9d952a662630f7bc1bce9b396763678bd600d
           stdout sha b74b81551364cf06e4ce4e05980339bdc2222cb67d1b0224e59e6d6130180005
ORBIT-MAP  verifier sha 0c5027d551a22acd05b3a7afee4bbf307e4a7db52471b0b56ad8eb406c095c31
           stdout sha d58390371093faba5540a1b38280279fcfc0e17185a472718b26bb0a5c753000
Commit pins (file shas live in the named outcome notes and lock
records of each source): SPLIT22 e4abd3f5, a9f91afe; knit 8686086b;
boost ladder 9c28ae2a; SL5 sum d341bf1e, 79a22296; coupling 0bda0daf;
ell-G ef93a86d, 56da9341; KCM-1..8 16aa1aa5, 5e684b25, 2adc6174,
c8df7108, 2c654943, 0215ce46, 837a921f, 0a9ea7be; census ef8756e6,
65991f3b, 3dbdb6cf, 828f5a40; Dirac prereg 125100f9, G1/G2 landing
99e592f0 (lock record in o_dirac_ladder/). All strikes and
closures above carry byte-identical aarch64 plus x86_64 stdout per
their own records; the kcm_measure CROSSPLATFORM_LOCK_RECORD carries
the KCM-9 section (944b5349).
```
...
```
Zero new free parameters (cumulative still 1, the m_e SI anchor).
No axiom change. No prior LOCK retracted.
New at T this fold: the FRW rank-1 (00) canonical form; the hosting
   rule theorems (multiplicities and 313 = 2 x 144 + 24 + 1); the
   pair-map exhaustion pair W-A, W-B; T-313-FACES;
   T-63-MERSENNE-FACE; T-HULL-CUBIC; T-33-FACES; the substrate knit
   quartet T-QS-BORN-FACES, T-QS-GRAM, T-QS-MUB, T-QS-QUANTA-MOMENTS;
   the Dirac ladder pair T-LADDER-LIGHTCONE, T-SPINOR-FLOOR.
New at D this fold: D-KCM-MAGNETIC-EMERGENCE; D-KCM-ORBIT-MAP;
   D-KCM-TICK-DIAGONAL; D-KCM-TICK-ELECTRIC-LAW;
   D-KCM-ELECTRIC-BLINDNESS; D-KCM-FORK-UNIFICATION;
   D-KCM-REALITY-TRAP; D-KCM-MOMENT-FACTORIZATION;
   D-KCM-SANDWICH-GALOIS-OBSTRUCTION; D-KCM-IRRATIONALITY-FILTER;
   D-PAIR-MAP; D-CENSUS-Z5-SHEET; D-PISTON-V4-HOSTING;
   D-313-B-INVARIANCE; D-SPLIT22; D-FROZEN-AXIS;
   D-BOOST-COUNT-LADDER; D-SS40-TIER1-OPTIMUM; D-MAXWELL era coupling
   discharge on 864 pi.
Fired this fold: eleven preregistered falsifier events, every one
   first-class; the ninth clause of the measure mismatch did NOT
   fire. No summary above is stronger than its committed source.
```

## One sentence

Eight corpses taught the measure its identikit and the ninth strike
found it alive: the verb, stood up as the pair of motions stay and
twist, measures its own magnetic face exactly, while the census that
began as a count of 313 ends as a theorem of the kernel breathing
Thue-Morse.

## Footer

```
TWIST-J Canon v159 CONSOLIDATED: the measure emerges and the census
becomes theorems.
A. M. Thorn.  twistj.com.  ORCID 0009-0008-5463-278X.
7 July 2026.
Vse je ONE. If it cannot be calculated in integers, it is not physics.
...
A. M. Thorn.  ORCID 0009-0008-5463-278X.  Hub: twistj.com.
Date: 7 July 2026.
Consolidates 935784d..e6b9023 (7 July 2026) on top of
TWIST_J_Canon_v159_CONSOLIDATED (0ed12b4, the measure emerges and the
census becomes theorems).
Every Part below summarizes a committed source named by its hash; no
summary is stronger than its committed label. No book (vesmirkniha)
prose falls in this span; the sources below are physics only.
```
...
One instrument finished and one opened. The Dirac ladder that entered
flight in v159 ran its last three gates and closed. G4 built the step
operator from the axiom with zero free parameters and read the
electron's mass off the determinant, det = 5 = p. G3 identified the
ladder root with the Arnold cat map carrier over Z. G5 decided the
place question: the ladder sign and the spin sign live at different
places, and charge conjugation is the swap of the two Gaussian primes
above p, a third instance of the Two Places prediction. All five gates
executed; the entry closes at D with its theorem layer at T. The
checkerboard between the rungs became a Gaussian tower x^2 - 2x + 5
with c^2 + d^2 = 5^n. And the return group of the electron's attractor
turned out to be the dihedral group D5, with an integer mass law
M(E) = 10|E|, opening the first non-abelian rung of the ladder toward
SL_3(F_5); its first dynamical probe found the dynamical color to be
Z_2 and turned the color question kinematical.

## Part I. The Dirac step: the electron's mass is the determinant (G4)

Sources: 935784d (construction, TWISTJ_Canon_Patch_D_DIRAC_STEP.md),
8dc078d (execution).

D-DIRAC-STEP CLOSED AT D (PREREG-DIRAC-LADDER gate G4; 15 of 15 both
architectures, byte-identical JAS 2 aarch64 and TWISTER x86_64). The
Dirac step operator is

```
D_J(m)(z) = S(z) (I + i m X)
```

forced from the axiom with zero free parameters: streaming S is the
counter, the coin modulus |coin| = m is the rest rung, the phase i is
the ellipticity of the plenum, the offset eps = 1. Massless is the
one-sided shift. The trace is kinetic only; the determinant is
det = 1 + m^2 = 5 = p for the electron. The mass shell is the
discriminant, Ehat^2 - phat^2 = m^2 exact, band [4, 5]; the rest coin
has infinite order. T-DIRAC-STEP-INVARIANTS, T-DIRAC-STEP-GENERATOR
(this anchors the checkerboard, Part IV) and T-REST-COIN-INFINITE-ORDER
promote to T. Per the preregistered path, O-DIRAC-LADDER promotes O to
D (G1 and G2 at T, G4 PASS). No falsifier fired.

## Part II. The ladder root is the cat map carrier (G3)

Sources: 1304c54 (derivation,
TWISTJ_Canon_Patch_D_FIB_ROOT_CARRIER.md), d5c0282 (execution).

D-FIB-ROOT-CARRIER CLOSED AT D (gate G3; 9 of 9 both architectures,
byte-identical). The ladder root is the carrier of
D-CARRIER-UNIFICATION: Fm^2 = C, the Arnold cat map over Z,
P-conjugate to the modulus channel B = N(sigma_J). Reduced mod 5,
sigma_J is a single Jordan block J_4(2), triangularized in the
pi-basis. The cyclic group <Fm> mod 5 is conjugate in GL(2, F_5) to
the 1-jet of the carrier, with an explicit conjugator. The residue
pairing at the inverse fourth root, 3 = 2^-1, is registered and handed
to G5. The towers have order 20 = 4p and 10 = 2p, with the involution
-I at half period on all four members. T-FIB-ROOT-NORM (the ladder
square is the carrier norm over Z) and T-FIB-ROOT-JET (the ladder root
is the carrier 1-jet mod 5) promote to T. O-DIRAC-LADDER stays at D;
the remaining movement runs through G5 alone. F-FIB-ROOT-MISMATCH not
fired; the source pins explicit matrices, so the inconclusive clause
did not engage.

## Part III. Charge conjugation is the place swap (G5, the final gate)

Sources: b34547c (decision, TWISTJ_Canon_Note_G5_PLACE_ID_Outcome.md),
e6b9023 (execution).

G5 PLACE-ID DECIDED: PASS-B, the disjunction (8 of 8 both
architectures, byte-identical). The ladder Z_2 (the norm character of
Z[phi]^x, Dirichlet chi5, conductor 5, the sqrt5 forces place) and the
spin Z_2 (sigma_fin on F_25, Dirichlet chi8, conductor 8, the sqrt2
place inside the zeta_8 world) are DISTINCT place-attached Galois
involutions; witness prime 7 (chi5 = -1, chi8 = +1), second witness
23. F-LADDER-SIGN-IS-SPIN FIRES AS SCOPED against the naive
identification.

New content: the Dirac step splits across the two places. The boost
determinant -1 = N(phi) sits at sqrt5; the coin determinant
5 = N(1 + 2i) sits at Q(i) with i = zeta_8^2. The G3 inverse fourth
root datum is the choice of Gaussian prime above p:
5 = (2 + i)(2 - i), with i = 3 mod (2 + i) and i = 2 mod (2 - i), and
charge conjugation = the place swap = Gal(Q(i)/Q). This is a THIRD
instance of the Two Places prediction: forces at sqrt5, spin at sqrt2,
charge conjugation at i. T-PLACE-DISJUNCTION and T-STEP-TWO-PLACES
promote to T; Two Places NOTE.3 confirmed.

```
ALL FIVE GATES OF O-DIRAC-LADDER ARE NOW EXECUTED:
   G1  T-LADDER-LIGHTCONE       (T)
   G2  T-SPINOR-FLOOR           (T)
   G3  D-FIB-ROOT-CARRIER       (D; T-FIB-ROOT-NORM, T-FIB-ROOT-JET)
   G4  D-DIRAC-STEP             (D; T-DIRAC-STEP-INVARIANTS,
                                    T-DIRAC-STEP-GENERATOR,
                                    T-REST-COIN-INFINITE-ORDER)
   G5  PLACE-ID                 (PASS-B; T-PLACE-DISJUNCTION,
                                    T-STEP-TWO-PLACES)
The entry closes at D with its theorem layer at T.
```

One falsifier fired as scoped (F-LADDER-SIGN-IS-SPIN); none fired
unexpectedly. R-FERMIONIZER-TWO stays R; O-ETA-ALTERNATOR-BRIDGE stays
O.

## Part IV. The checkerboard is a Gaussian tower

Sources: abcd3ee (preregistration,
TWISTJ_Canon_Preregistration_H_DIRAC_CHECKERBOARD.md), abd8ef2
(execution).

H-DIRAC-CHECKERBOARD PROMOTED H to D (PREREG-DIRAC-CHECKERBOARD;
CB1 CB2 CB3, 10 of 10 both architectures, byte-identical). The
umbrella covers statement parts (1) through (4):

- T-CHECKERBOARD-SKELETON: the parity law R = channel parity; closed
  form one binomial pair per case, N_R = C(a,r) C(b-1,r-1)
  same-channel and C(a,r-1) C(b-1,r-1) cross-channel; resummation
  = W^n.
- T-CHECKERBOARD-ALTERNATOR-SPLIT: the diagonal in Z with pair weight
  -(u v) = -4, the cross in iZ; the unsigned companion S(I + 2X) has
  det -3 with the same skeleton.
- T-CHECKERBOARD-GAUSS-TOWER: sum t^R = (1 + t)^n; totals (1 + 2i)^n;
  recursion x^2 - 2x + 5; c^2 + d^2 = 5^n; zone edge -5I electron,
  -I photon.

All three promote to T. The naming clause (5), plain : alternating
= zeta-side : eta-side, stays R; gate CB4 (D-CHECKERBOARD-ETA-NAMING)
remains open and is the only gate that can move it. O-ETA-ALTERNATOR-
BRIDGE unchanged at O. No falsifier fired.

## Part V. The return group is dihedral and the mass law is integer

Sources: 42672ca (H1-D5-LIFT), 436d921 (D5-RUNG-2), 548a96e
(D5-RUNG-3A). This program lifts the abelian face measure of v159
toward color: it climbs the ladder from the electron attractor into
the non-abelian regime one preregistered rung at a time.

PREREG-H1-D5-LIFT (42672ca, 5 of 5 both architectures, byte-identical):
the return group of the attractor IS the dihedral group D5. T-H1-
DIHEDRAL, T-D5-GOLDEN-TABLE and T-D5-MASS-LAW M(E) = 10|E| promote to
T; six hand predictions land exact in Q(sqrt5). D-D5-CLASS-BLINDNESS
and D-D5-SIGN-DARKNESS registered. H-D5-QCD-RUNG opens the non-abelian
ladder toward SL_3(F_5).

PREREG-D5-RUNG-2 (436d921, 6 of 6 both architectures, byte-identical):
T-D5-TORSOR (the attractors are D5 torsors, the special pentagon is
the axis set); T-SP-HOLONOMY (the Klein image on ker Tr_4);
T-SP-ORIENTATION (det = tick parity, the dark channel = orientation
reversal, Phi in SL_3(F_5)); D-SP-SPLIT12 (3 = 1 + 2). H-D5-RUNG-3
opens the color question.

PREREG-D5-RUNG-3A (548a96e, 5 of 5 both architectures, byte-identical):
the dynamical census-symmetry group is C0 = <b, T0, Phi> of order 20,
and the candidate sweep is null. F-RUNG3-TRIVIAL-DYNAMICAL FIRES AS
REGISTERED: the dynamical color is Z_2, and the ladder turns
kinematical; PREREG-D5-RUNG-3B (the kinematical half, its algorithm
fixed inside the 3A preregistration before the run) is registered as
the successor. D-RUNG3-TRANSPORT registered, the rev 1 ordering defect
disclosed and kept.

## Falsification registry (v160 delta)

```
FIRED, first-class, all preregistered:
   F-LADDER-SIGN-IS-SPIN (G5, as scoped: the ladder sign and the spin
      sign are distinct place-attached involutions; the naive
      identification dies);
   F-RUNG3-TRIVIAL-DYNAMICAL (D5-RUNG-3A, as registered: the dynamical
      color is Z_2, not the full non-abelian rung; the ladder turns
      kinematical to PREREG-D5-RUNG-3B).
REGISTERED AND SILENT: F-FIB-ROOT-MISMATCH (G3); the G4 Dirac-step
   falsifiers; the DIRAC-CHECKERBOARD falsifier.
Rev 1 discipline: D5-RUNG-3A rev 1 self-caught at gate S4 (exit 1,
   4 of 5, stdout kept as evidence, committed as
   rung3a_stdout_jas2_r1_S4_FIRED.txt); the exit-nonzero no-verdict
   rule held.
No falsifier fired against any prior LOCK.
```

## Open obligations (v160 delta)

```
CLOSED at D   O-DIRAC-LADDER (all five gates executed; the entry
              closes at D, its theorem layer at T);
              D-FIB-ROOT-CARRIER; D-DIRAC-STEP.
PROMOTED      H-DIRAC-CHECKERBOARD, H to D (parts 1 to 4); the naming
              clause stays R.
ANSWERED      H-D5-RUNG-3: the dynamical color is Z_2 (via
              F-RUNG3-TRIVIAL-DYNAMICAL).
OPENED        PREREG-D5-RUNG-3B (the kinematical color half, algorithm
              preregistered);
              CB4 (D-CHECKERBOARD-ETA-NAMING), the only gate that can
              promote the checkerboard naming clause;
              H-D5-QCD-RUNG (the first rung of the non-abelian ladder
              toward SL_3(F_5)).
STILL OPEN    O-ETA-ALTERNATOR-BRIDGE; O-KCM-CROSSING-FUNCTIONAL
              (v159); R-FERMIONIZER-TWO stays R.
THE WALL NOW  unchanged in kind: O-QUANT-SUBSTRATE gates PS-G-2 and
              Gb; the non-abelian measure lift on the SL_3(F_5) side,
              now with an explicit first rung (H-D5-QCD-RUNG); the
              shared archimedean 2 pi U(1) circle.
```

## Verifier index (v160 delta)

```
DIRAC G4   verifier sha b1ad8bc196655b1be0f4c171ccced0dd31bae75d2bdf9fabf3b4bb3029d085bc
           stdout   sha dd76e5bfab53d3f972735b7c504d3f22309277ebc98008eb287673ecd478dac5
           (15 of 15; construction patch 935784d)
DIRAC G3   verifier sha 5deae65994263cd529668c6e0f9921e90415a66a02afafaa08fc07640ad4563e
           stdout   sha dbbdc9cbc87f875fd547872b9493bea40d93b65f55399e4c582094ce329ee1aa
           (9 of 9; derivation patch 1304c54)
DIRAC G5   verifier sha 23919253e21982e6d782aa578371b40ef2d9b50c6fa97af6b47843c26b02d8a4
           stdout   sha cbf35e6b160bbaa7937894be4ee342730ac5a9dddfd5eef170f5f6e672643272
           (8 of 8; decision note b34547c)
CHECKERBD  verifier sha d87f38d5892c1536b830ca5ee55c34bfbe6fab2e7301facaa27455823743f5ef
           stdout   sha 0f88092aa04e17c91e271a9a0b2795f66d0df58ea0e8ea8b1b588da56d40dded
           (10 of 10; preregistration abcd3ee)
H1-D5-LIFT prereg   sha 6978c5949b8f86fa25f7855fcbc4e394335ef32c5ba630cfee605289b8ea53cd
           probe    sha b46dcf54591fd36fb4b4e5665ebc18c085f0315bc09a9cb665604c7d9f031372
           stdout   sha 65eba3224f95cea9ced6ed27c0dee0e9046b62e2cf1033ef8f973521b6959795
           (5 of 5; commit 42672ca)
D5-RUNG-2  prereg   sha b9807232b249b6b99316b8aee1860c16176a110ca44999fb4937c2a45a6d7202
           probe    sha 13898660c7f5a5c17e8e5860db9138da448803228087b4ba30d5491daac94ea4
           stdout   sha 67d5ee7b73afdab9d6ca9f3b32b1a78e3b277e4476aa2fcef6433dfe05fde9a0
           (6 of 6; commit 436d921)
D5-RUNG-3A prereg     sha 838a45449cc443212d05015af904ddba0b504043370c64e0d7ecc808039390da
           probe rev2 sha 68a50ff0910e96f501e1a88870a91576b6238f7b37434c199813e2c4ba42919f
           stdout     sha e89a7dd6e514999926b464e72c0f8676e28821b113ed18cb7b153dcb578fd9b8
           (5 of 5; commit 548a96e; rev 1 stdout 156ff566... at gate S4,
            exit 1, 4 of 5, kept)
G1/G2      restated for the completed ladder (source in v159):
           verifier sha 514be82ed02ba410157b228eae3a144692eb63508aaedf2723fa32a6bdf44e94
           stdout   sha aa699fb9434b28379fdb645a87449088d7e56ec2dcc0f6fe01c911dd15b3ffd8
           (25 of 25; preregistration 125100f9)
All gates above carry byte-identical aarch64 (JAS 2) plus x86_64
(TWISTER) stdout per their own lock records. The Dirac ladder record
lives in phibit/canon_cayley/o_dirac_ladder/CROSSPLATFORM_LOCK_RECORD,
the checkerboard in phibit/canon_cayley/dirac_checkerboard/, the D5
rungs in phibit/canon_cayley/d5_lift/.
```
...
Zero new free parameters (cumulative still 1, the m_e SI anchor).
No axiom change. No prior LOCK retracted.
New at T this fold: T-DIRAC-STEP-INVARIANTS, T-DIRAC-STEP-GENERATOR,
   T-REST-COIN-INFINITE-ORDER (G4); T-FIB-ROOT-NORM, T-FIB-ROOT-JET
   (G3); T-PLACE-DISJUNCTION, T-STEP-TWO-PLACES (G5);
   T-CHECKERBOARD-SKELETON, T-CHECKERBOARD-ALTERNATOR-SPLIT,
   T-CHECKERBOARD-GAUSS-TOWER (checkerboard); T-H1-DIHEDRAL,
   T-D5-GOLDEN-TABLE, T-D5-MASS-LAW (H1-D5-LIFT); T-D5-TORSOR,
   T-SP-HOLONOMY, T-SP-ORIENTATION (D5-RUNG-2).
New at D this fold: D-DIRAC-STEP; D-FIB-ROOT-CARRIER;
   D-D5-CLASS-BLINDNESS; D-D5-SIGN-DARKNESS; D-SP-SPLIT12;
   D-RUNG3-TRANSPORT; H-DIRAC-CHECKERBOARD promoted to D;
   O-DIRAC-LADDER closed at D.
Fired this fold: two preregistered falsifier events, both first-class
   (F-LADDER-SIGN-IS-SPIN, F-RUNG3-TRIVIAL-DYNAMICAL). No summary
   above is stronger than its committed source.
```

## One sentence

The electron's ladder, entered in flight, ran its last three gates and
closed: its step is the axiom with the mass read off the determinant,
its root is the cat map, its charge conjugation is the swap of the two
primes above five, and the group that returns the attractor to itself
is the dihedral D5 whose integer mass law opens the first rung toward
color.

## Footer

```
TWIST-J Canon v160 CONSOLIDATED: the Dirac ladder closes and the
return group is dihedral.
A. M. Thorn.  twistj.com.  ORCID 0009-0008-5463-278X.
7 July 2026.
Vse je ONE. If it cannot be calculated in integers, it is not physics.
```
